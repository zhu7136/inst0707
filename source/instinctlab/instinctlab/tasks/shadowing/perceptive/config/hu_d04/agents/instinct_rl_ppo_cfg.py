...
@configclass
class HU_D04PerceptiveShadowingPPORunnerCfg(InstinctRlOnPolicyRunnerCfg):
    ...
    save_interval = 1000
    log_interval = 10
    experiment_name = "hu_d04_perceptive_shadowing"

    load_run = None

    # WANDB configuration
    use_wandb: bool = True
    wandb_project: str = "instinctlab_hu_d04_shadowing"
