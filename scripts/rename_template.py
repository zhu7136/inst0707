...
It renames all the occurrences of instinctlab (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the instinctlab folder
        os.rename(
            os.path.join(root_dir_path, "source", "instinctlab", "instinctlab"),
            os.path.join(root_dir_path, "source", "instinctlab", new_name),
        )
        os.rename(os.path.join(root_dir_path, "source", "instinctlab"), os.path.join(root_dir_path, "source", new_name))
